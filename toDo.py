...
#python create_dagman.py "SIG4" "VarSig" [30] [5] detector="1111" gamma=2.13 catalog="NVSS" useCatalogPos=5 useAlm=True Renorm=False UseGalPlane=True OnlyGalPlane=False
#python create_dagman.py "SIG5" "VarSig" [30] [5] detector="1111" gamma=2.13 catalog="NVSS" useCatalogPos=5 useAlm=True Renorm=False UseGalPlane=True OnlyGalPlane=True
#python create_dagman.py "SIG6" "VarSig" [30] [5] detector="1111" gamma=2.13 catalog="NVSS" useCatalogPos=5 useAlm=True Renorm=False UseGalPlane=False OnlyGalPlane=False
#useCatalogPos
print toDo
print "start list..."
os.system(toDo)
